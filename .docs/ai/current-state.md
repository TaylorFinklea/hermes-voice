...
- **Builds:** build 7 (`022728f`) uploaded = Phase 1 conversation control + barge-in fix (`8a687fd`) + History fix (`efd121f`). (Builds 5 `5b7e786`, 6 `a89a966` earlier.) Phase 2 (live tool-calls) + the voice picker are committed but await the **next build** — user authorizes each release.
